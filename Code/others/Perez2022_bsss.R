...
library(stringr)
library(cluster)
load("../../results/BatchStudy/dist_mat_Perez2022_PCAupdate.Rda")
load("../../results/BatchStudy/dist_mat_Perez2022_PCAupdate_addon.Rda")
...
for(i in 1:100){
  ...
  meta_boot <- meta[boot_id,]
    ...
    ss_harbat <- get_ss(meta_boot, dist_mat_GMM_har_batch[boot_id, boot_id], "batch", "group")
...
save(stat_list, file = "../../results/BatchStudy/Perez2022_BSss.Rda")
