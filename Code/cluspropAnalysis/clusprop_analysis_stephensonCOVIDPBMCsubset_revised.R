here::i_am("Code/cluspropAnalysis/clusprop_analysis_stephensonCOVIDPBMCsubset_revised.R")

source(here::here("Code","cluspropAnalysis","clusprop_helpers.R"))
dataset_name <- "stephensonCOVIDPBMCsubset"
file_name <- "stephensonCOVIDPBMC"
...
dist_mat_GMM_PCA_orig <- readRDS(here::here("results","Processed_Datasets",file_name,
    paste0(file_name,"_default"),paste0(file_name,"_default_PCA_GMM_matrix.Rds")))
...
dist_mat_KNN_PCA_orig <- readRDS(here::here("results","Processed_Datasets",file_name,
    paste0(file_name,"_default"),paste0(file_name,"_default_PCA_KNN_matrix.Rds")))
...
if(!file.exists(here::here("results","Revision","cluspropFinal",paste0(dataset_name,".h5ad")))){
    library(sceasy)
    library(Seurat)
    seurat_object <- readRDS(here::here("data","Processed_Datasets",file_name,
        paste0(file_name,"_default"), paste0(file_name,"_default.Rds")))
