here::i_am("Code/cluspropAnalysis/clusprop_clustering_stephensonCOVIDPBMCsubset_revised.R")
...
cell_mask <- (seurat_object[[]]$Status %in% c("Covid","Healthy"))
seurat_object <- seurat_object[,cell_mask]
...
save_path <- paste0("Code/cluspropAnalysis/clustered_data/",dataset_name,"subset_clustered_revised.RDS")
