---
title: "Process Arnon et al. (2018) ICI-resistant Melanoma Data"
author: "Purdom Group"
date: "`r Sys.Date()`"
...
group_str <- "treatment.group" # The group (phenotype/condition) covariate
sample_str <- "sample_id" # The sample ID within a patient
cell_type_str <- "cell.types" # The cell type covariate
batch_str <- "Cohort" # The covariate associated with any possible batch effect such as processing site or date
...
aggregation_variable <- "sample" # e.g. "sample"
subset_variable <- "cell_type" # e.g. "cell_type"
