...
patient_str <- "patient" # The string of the patient ID covariate
group_str <- "tissue"# The group (phenotype/condition) covariate
sample_str <- "sample" # The sample ID within a patient
cell_type_str <- "cluster.name" # The cell type covariate
