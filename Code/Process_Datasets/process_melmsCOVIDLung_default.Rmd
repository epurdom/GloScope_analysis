---
title: "Process Melms et al. (2021) COVID-infected Lung Tissue Data"
author: "Purdom Group"
date: "`r Sys.Date()`"
...
group_str <- "group" # The group (phenotype/condition) covariate
sample_str <- "sample_id" # The sample ID within a patient
cell_type_str <- "cell_type_fine" # The cell type covariate
