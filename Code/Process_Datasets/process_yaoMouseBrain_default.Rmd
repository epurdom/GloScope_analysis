---
title: "Process Yao et al. (2021) Allen Brain Atlas Mouse Data"
author: "Purdom Group"
date: "`r Sys.Date()`"
...
options(error = quote(dump.frames("allenMouseErrorDump", TRUE))) # error logging
library(here)
...
patient_str <- "donor_label" # The string of the patient ID covariate
group_str <- "joint_region_label" # The group (phenotype/condition) covariate
sample_str <- "sample" # The sample ID within a patient
cell_type_str <- "label" # The cell type covariate
...
metadata_mat <- readRDS(here::here("data","Processed_Datasets","yaoMouseBrain","raw_files","metadata.Rds"))
metadata_formatted_df <- format_metadata_df(metadata_mat,
...
colData(sce_object) <- metadata_formatted # update object
```
