...
dataset_name <- "ledergorMyeloma"
program_name <- "default"
primary_assay <- "RNA"
check_initial_seurat_save <- TRUE
...
group_str <- "sample_type" # The group (phenotype/condition) covariate
sample_str <- "Amp_batch_ID" # The sample ID within a patient
