...
# run scvi for the default covidLung processing
...
seurat_object <- readRDS("data/Processed_Datasets/melmsCOVIDLung/melmsCOVIDLung_default/melmsCOVIDLung_default.Rds") 
...
saveRDS(seurat_object,"data/Processed_Datasets/melmsCOVIDLung/melmsCOVIDLung_default/melmsCOVIDLung_default.Rds")
