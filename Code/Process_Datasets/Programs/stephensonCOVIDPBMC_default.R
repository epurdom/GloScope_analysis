...
build_seurat_object <- function(dataset_name,program_name,assay_name="RNA",save_formats=c("seurat")){
	...
	SeuratDisk::Convert(source=here::here("data","Processed_Datasets","stephensonCOVIDPBMC","raw_files","covid_portal_210320_with_raw.h5ad"),
				   dest=here::here("data","Processed_Datasets","stephensonCOVIDPBMC","raw_files","covid_portal_210320_with_raw.h5seurat"), overwrite = TRUE)
	...
	seurat_object <- SeuratDisk::LoadH5Seurat(here::here("data","Processed_Datasets","stephensonCOVIDPBMC","raw_files","covid_portal_210320_with_raw.h5seurat"))
        ...
        metadata_df <- seurat_object[[]]
	saveRDS(metadata_df,here::here("data","Processed_Datasets","stephensonCOVIDPBMC","raw_files","metadata.Rds"))
...
preprocessing <- function(seurat_object){
	...
	# Seurat's nFeature_RNA, which we rename num_features, already omits zero expression genes
	return(seurat_object)
}
