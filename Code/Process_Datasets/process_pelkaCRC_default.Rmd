---
title: "Process Pelka Colorectal Cancer Data"
author: "Purdom Group"
date: "`r Sys.Date()`"
...
group_str <- "MMRStatusTumor" # The group (phenotype/condition) covariate
sample_str <- "PatientTypeID" # The sample ID within a patient
cell_type_str <- "clTopLevel" # The cell type covariate
batch_str <- "TissueSource" # The covariate associated with any possible batch effect such as processing site or date
...
aggregation_variable <- "patient" 
subset_variable <- "group"
