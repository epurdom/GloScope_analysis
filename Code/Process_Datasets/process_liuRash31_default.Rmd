---
title: "Process Liu et al. (2021) 31 Sample Rash Data"
author: "Purdom Group"
date: "`r Sys.Date()`"
...
patient_str <- "donor" # The string of the patient ID covariate
group_str <- "dis" # The group (phenotype/condition) covariate
sample_str <- "sample" # The sample ID within a patient
cell_type_str <- "Ident2" # The cell type covariate
