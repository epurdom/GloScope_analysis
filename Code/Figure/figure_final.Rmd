...
par(xpd=TRUE)
legend("bottomright", fill = colorBlindBlack8[-4], legend =c("MMRd","MMRp","Normal"))
...
df = plotMDS(sqrt(dist_mat_GMM_har),n = 2, x = meta, sample_id = "batch_id", group_id = "disease_state")$mds
