...
```{r}
df = plotMDS(sqrt(dist_mat_GMM_PCA),n = 2, x = meta, sample_id = "PatientTypeID", group_id = "MMRStatusTumor")$mds
...
sub_dist = dist_mat_GMM_PCA[sub_meta$sample, sub_meta$sample]
