...
par_list = Step1(x, mysd = 0.13, nk,ns,ng, dd, force, rel_lfc, paired, lfc, probs, p_dd,  p_type = 0,
                 phylo_tree =NULL, offset = NULL, cats = cats_vec,  samp_off = NULL, alpha = 1)
set.seed(as.numeric(slurm_arrayid))
rm(x)
...
save(clus_true,clus_seurat_pca, clus_seurat_scvi, 
     file =  paste0("../../results/simulation/distmat/clusprop_V3/Setting1/25_100_alpha1/cluster/",slurm_arrayid ,".Rda" ))

save(dist_mat_KNN_pca,dist_mat_GMM_pca,
  dist_mat_KNN_scvi,dist_mat_GMM_scvi, 
    file = paste0("../../results/simulation/distmat/clusprop_V3/Setting1/25_100_alpha1/Glos/",slurm_arrayid,".Rda"))
