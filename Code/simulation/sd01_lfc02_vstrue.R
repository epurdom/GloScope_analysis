...
par_list = Step1(x, mysd = 0.1, nk,ns,ng, dd, force, rel_lfc, paired, lfc, probs, p_dd,  p_type = 0,
...
save(dist_mat_KNN_pca,dist_mat_GMM_pca,
  dist_mat_KNN_scvi,dist_mat_GMM_scvi,
    file = paste0("../../results/simulation/vstrue/sd01_lfc02_n4/",slurm_arrayid,".Rda"))
