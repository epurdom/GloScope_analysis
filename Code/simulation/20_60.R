...
A_clus = c(60,100,90,100,110,100,95,100)
...
save(clus_true,clus_seurat_pca, clus_seurat_scvi,
     file =  paste0("../../results/simulation/distmat/clusprop_V3/Setting3/20_60/cluster/",slurm_arrayid ,".Rda" ))

save(dist_mat_KNN_pca,dist_mat_GMM_pca,
  dist_mat_KNN_scvi,dist_mat_GMM_scvi,
    file = paste0("../../results/simulation/distmat/clusprop_V3/Setting3/20_60/Glos/",slurm_arrayid,".Rda"))
