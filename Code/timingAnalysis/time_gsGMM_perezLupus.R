here::i_am("Code/timingAnalysis/time_gsGMM_perezLupus.R")

library(GloScope)

sce_object <- readRDS(here::here("data","Processed_Datasets","perezLupus","perezLupus_default","perezLupus_default.Rds"))
...
saveRDS(timing_vector,here::here("Code","timingAnalysis","timing_results","perezLupus_gsGMM.RDS"))