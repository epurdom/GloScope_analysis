here::i_am("Code/timingAnalysis/time_gsGMM_fabreLung.R")

library(GloScope)

seurat_object <- readRDS(here::here("data","Processed_Datasets","fabreLung","fabreLung_default","fabreLung_default.Rds"))

embedding_matrix <- seurat_object@reductions$pca@cell.embeddings
cell_sample_ids <- seurat_object@meta.data$sample
...
saveRDS(timing_vector,here::here("Code","timingAnalysis","timing_results","fabreLung_gsGMM.RDS"))